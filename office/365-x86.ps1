...
$xmlUrl = "https://raw.githubusercontent.com/renan-portes/install/main/office/365-x86.xml"
...
Invoke-WebRequest -Uri $xmlUrl -OutFile "$tempFolder\365-x86.xml"

# Execute o comando de instalação do Office
Start-Process -FilePath "$tempFolder\setup.exe" -ArgumentList "/configure $tempFolder\365-x86.xml" -Wait
